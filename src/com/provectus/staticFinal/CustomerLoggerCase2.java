...
public class CustomerLoggerCase2 {
    ...
    public static void info(String message) {
        System.out.println(YELLOW_BOLD_BRIGHT + String.format(message));
    }

    public static void debug(String message) {
        System.out.println(BLUE_BOLD_BRIGHT + String.format(message));
    }

    public static void error(String message) {
        System.out.println(RED_BOLD_BRIGHT + String.format(message));
    }

    public static void warning(String message) {
        System.out.println(GREEN_BOLD_BRIGHT + String.format(message));
    }
